...
export default function Table({ columns, rows }: TableProps) {
  // Función para calcular la altura de las filas
  const getRowHeight = (params: GridRowHeightParams) => {
    const numberOfTags = params.model.tags?.length || 1;
    return 52 + (numberOfTags - 1) * 20; // Ajusta el cálculo según sea necesario
  };
  ...
  return (
    ...
    >
      <DataGrid
        ...
        rowHeight={52} // Establece una altura predeterminada para las filas
      />
    </Box>
  );
}
